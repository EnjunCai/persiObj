  ...
  <div class="note-wrapper">
    ...
    <div class="content-wrapper">
      <div class="content">
        ...
        <div class="main">
          <div v-for="(item, index) in list" :key="item.id" class="item" @click="router.push(`/noteInfo/${item.id}`)">
      ...
      <div class="aside">
        <div>
          ...
          <div class="tags-wrapper">
            <div class="tag" v-for="item in tagList" :key="item.id" @click="router.push(`/note?tag=${item.title}`)">
              {{ item.title }}
            </div>
          </div>
        </div>
