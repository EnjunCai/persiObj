<template>
  <div class="home_wrapper" :style="{transform: `translate3d(0px,{{ -screenWidth }}, 0px)`}">
    <div class="info_wrapper">
      <div class="info_text" >
        <p v-observe="{ animationName: 'activeObserve', move: 'bottom' }">Hello!</p>
    ...
    <div class="card_wrapper1">
      ...
      <a href="https://kira-learning.org/" target="_black" class="w7 w7R"
        v-observe="{ animationName: 'activeObserve', move: 'bottom' }">
        <div class="w7_text">
          <p>kira学习平台</p>
